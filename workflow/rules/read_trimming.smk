rule trim_reads_pe:
    ...
    output:
        r1="results/{plate}/trimming/trimmomatic/paired/{sample}.1.fastq.gz",
        r2="results/{plate}/trimming/trimmomatic/paired/{sample}.2.fastq.gz",
        ...
        trimlog=temp("results/{plate}/trimming/trimmomatic/paired/{sample}.trimlog.txt")
    params:
...
rule trim_reads_se:
    ...
    params:
        **config["trimmomatic"]["pe"]
    log:
        "results/{plate}/trimming/trimmomatic/log/single/{sample}.log"
    threads:
        resources['trimmomatic']['threads']
    resources:
        mem_mb=resources['trimmomatic']['mem']
